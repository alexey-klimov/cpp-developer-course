/* Задание
 *
 * Сделайте класс Rational более надёжным, запретив операцию деления на ноль. Доработайте Rational
 * так, чтобы при попытке деления дроби на 0 оператором / либо /= выбрасывалось исключение
 * invalid_argument. Следующий код иллюстрирует обработку данного типа исключений:
 */
